  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-2xl text-center">
        ...
        {description && (
          <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-gray-300">
            {description}
          </p>
        )}
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          {primaryAction && (
            <CTAButton {...primaryAction} variant="secondary" />
          )}
          {secondaryAction && (
            <CTAButton {...secondaryAction} variant="ghost" />
          )}
          {actions &&
            actions.map((action, index) => (
              <CTAButton key={index} {...action} />
  ...
  if (type === "video") {
    return (
      <video
        ...
        muted
        loop
        className={cn("w-full rounded-xl shadow-xl", className)}
      >
